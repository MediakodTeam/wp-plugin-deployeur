...
<div class="relative mkd-wrapper">
	...
	<?php if (isset($history) && !empty($history)) : ?>
		<div class="px-5 pt-2 pb-2 mt-12 -ml-5 sm:pb-0 lg:px-12">
			...
			<div class="md:flex md:items-center md:justify-between">
				...
				<div class="flex mt-4 md:mt-0 md:ml-4">
					<button type="button" class="inline-flex items-center px-4 py-2 text-sm font-medium !text-white !bg-blue-500 !border-0 hover:!bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue focus:ring-offset-2">
