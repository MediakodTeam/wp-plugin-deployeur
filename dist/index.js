...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _helpers_i18n__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../helpers/i18n */ \"./assets/scripts/helpers/i18n.ts\");\n/* harmony import */ var _modules_modal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../modules/modal */ \"./assets/scripts/modules/modal/index.ts\");\nvar __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {\n    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }\n    return new (P || (P = Promise))(function (resolve, reject) {\n        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }\n        function rejected(value) { try { step(generator[\"throw\"](value)); } catch (e) { reject(e); } }\n        function step(result) { result.done ? resolve(result.value) : adopt(result.value).then(fulfilled, rejected); }\n        step((generator = generator.apply(thisArg, _arguments || [])).next());\n    });\n};\nvar __generator = (undefined && undefined.__generator) || function (thisArg, body) {\n    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g;\n    return g = { next: verb(0), \"throw\": verb(1), \"return\": verb(2) }, typeof Symbol === \"function\" && (g[Symbol.iterator] = function() { return this; }), g;\n    function verb(n) { return function (v) { return step([n, v]); }; }\n    function step(op) {\n        if (f) throw new TypeError(\"Generator is already executing.\");\n        while (g && (g = 0, op[0] && (_ = 0)), _) try {\n            if (f = 1, y && (t = op[0] & 2 ? y[\"return\"] : op[0] ? y[\"throw\"] || ((t = y[\"return\"]) && t.call(y), 0) : y.next) && !(t = t.call(y, op[1])).done) return t;\n            if (y = 0, t) op = [op[0] & 2, t.value];\n            switch (op[0]) {\n                case 0: case 1: t = op; break;\n                case 4: _.label++; return { value: op[1], done: false };\n                case 5: _.label++; y = op[1]; op = [0]; continue;\n                case 7: op = _.ops.pop(); _.trys.pop(); continue;\n                default:\n                    if (!(t = _.trys, t = t.length > 0 && t[t.length - 1]) && (op[0] === 6 || op[0] === 2)) { _ = 0; continue; }\n                    if (op[0] === 3 && (!t || (op[1] > t[0] && op[1] < t[3]))) { _.label = op[1]; break; }\n                    if (op[0] === 6 && _.label < t[1]) { _.label = t[1]; t = op; break; }\n                    if (t && _.label < t[2]) { _.label = t[2]; _.ops.push(op); break; }\n                    if (t[2]) _.ops.pop();\n                    _.trys.pop(); continue;\n            }\n            op = body.call(thisArg, _);\n        } catch (e) { op = [6, e]; y = 0; } finally { f = t = 0; }\n        if (op[0] & 5) throw op[1]; return { value: op[0] ? op[1] : void 0, done: true };\n    }\n};\n\n\nvar defineFetchMethod = function (hosting) {\n    switch (hosting) {\n        case \"Netlify\":\n            return \"POST\";\n        case \"Vercel\":\n            return \"GET\";\n        default:\n            return \"POST\";\n    }\n};\nvar handleDeployTrigger = function () {\n    // Handle deploy button\n    var triggersDeploy = document.querySelectorAll(\"#trigger-deploy\");\n    if (!triggersDeploy || triggersDeploy.length === 0) {\n        return;\n    }\n    var _loop_1 = function (i) {\n        var triggerDeploy = triggersDeploy[i];\n        var modalType = triggerDeploy.dataset.deployType;\n        var modalLoading = new _modules_modal__WEBPACK_IMPORTED_MODULE_1__.Modal({\n            title: (0,_helpers_i18n__WEBPACK_IMPORTED_MODULE_0__.getTranslations)(\"loading\"),\n            content: (0,_helpers_i18n__WEBPACK_IMPORTED_MODULE_0__.getTranslations)(modalType === \"revalidate\" ? \"revalidate-loading\" : \"deploy-loading\"),\n            type: \"info\",\n            hideConfirmButton: true,\n        });\n        var modalSuccess = new _modules_modal__WEBPACK_IMPORTED_MODULE_1__.Modal({\n            title: (0,_helpers_i18n__WEBPACK_IMPORTED_MODULE_0__.getTranslations)(\"success\"),\n            content: (0,_helpers_i18n__WEBPACK_IMPORTED_MODULE_0__.getTranslations)(modalType === \"revalidate\" ? \"revalidate-success\" : \"deploy-success\"),\n            type: \"success\",\n        });\n        var modalError = new _modules_modal__WEBPACK_IMPORTED_MODULE_1__.Modal({\n            title: (0,_helpers_i18n__WEBPACK_IMPORTED_MODULE_0__.getTranslations)(\"error\"),\n            content: (0,_helpers_i18n__WEBPACK_IMPORTED_MODULE_0__.getTranslations)(modalType === \"revalidate\" ? \"revalidate-error\" : \"deploy-error\"),\n            type: \"error\",\n        });\n        var ajaxURL = triggersDeploy[0].dataset\n            .ajaxUrl;\n        console.log(\"Trigger deploy \", triggerDeploy);\n        triggerDeploy.addEventListener(\"click\", function () { return __awaiter(void 0, void 0, void 0, function () {\n            var webhookData, res, data;\n            return __generator(this, function (_a) {\n                switch (_a.label) {\n                    case 0:\n                        modalLoading.showModal();\n                        webhookData = {\n                            action: modalType === \"revalidate\"\n                                ? \"mkd_revalidate_path\"\n                                : \"mkd_fetch_webhooks\",\n                            webhooks: triggerDeploy.dataset.deployWebhook,\n                            method: defineFetchMethod(triggerDeploy.dataset.deployHosting),\n                            post_id: triggerDeploy.dataset.postId,\n                            path: triggerDeploy.dataset.revalidatePath,\n                        };\n                        return [4 /*yield*/, fetch(ajaxURL, {\n                                method: \"POST\",\n                                headers: {\n                                    \"Content-Type\": \"application/x-www-form-urlencoded\",\n                                    \"Cache-Control\": \"no-cache\",\n                                },\n                                body: new URLSearchParams(webhookData),\n                            })];\n                    case 1:\n                        res = _a.sent();\n                        console.log(\"Trigger deploy \", triggerDeploy);\n                        data = {\n                            action: \"mkd_log_history\",\n                            status: res.ok ? \"success\" : \"error\",\n                            webhooks: modalType === \"revalidate\"\n                                ? triggerDeploy.dataset.revalidatePath\n                                : triggerDeploy.dataset.deployWebhook,\n                            type: modalType,\n                        };\n                        // Log deploy trigger into db\n                        return [4 /*yield*/, fetch(ajaxURL, {\n                                method: \"POST\",\n                                headers: {\n                                    \"Content-Type\": \"application/x-www-form-urlencoded\",\n                                    \"Cache-Control\": \"no-cache\",\n                                },\n                                body: new URLSearchParams(data),\n                            })];\n                    case 2:\n                        // Log deploy trigger into db\n                        _a.sent();\n                        modalLoading.hideModal();\n                        if (!res.ok) {\n                            modalError.showModal();\n                        }\n                        else {\n                            modalSuccess.showModal();\n                        }\n                        return [2 /*return*/];\n                }\n            });\n        }); });\n    };\n    for (var i = 0; i < triggersDeploy.length; i++) {\n        _loop_1(i);\n    }\n};\nvar handleClearHistory = function () {\n    // Handle clear history\n    var clearHistory = document.getElementById(\"clear-history\");\n    if (!clearHistory) {\n        return;\n    }\n    var modalConfirmClear = new _modules_modal__WEBPACK_IMPORTED_MODULE_1__.Modal({\n        title: (0,_helpers_i18n__WEBPACK_IMPORTED_MODULE_0__.getTranslations)(\"confirm-clear\"),\n        content: (0,_helpers_i18n__WEBPACK_IMPORTED_MODULE_0__.getTranslations)(\"confirm-clear-content\"),\n        type: \"warning\",\n    }, function () { return __awaiter(void 0, void 0, void 0, function () {\n        var ajaxURL, data;\n        return __generator(this, function (_a) {\n            switch (_a.label) {\n                case 0:\n                    console.log(\"Clear history now\");\n                    ajaxURL = clearHistory.dataset.ajaxUrl;\n                    data = {\n                        action: \"mkd_clear_history\",\n                    };\n                    return [4 /*yield*/, fetch(ajaxURL, {\n                            method: \"POST\",\n                            headers: {\n                                \"Content-Type\": \"application/x-www-form-urlencoded\",\n                                \"Cache-Control\": \"no-cache\",\n                            },\n                            body: new URLSearchParams(data),\n                        })];\n                case 1:\n                    _a.sent();\n                    // Reload the page\n                    window.location.reload();\n                    return [2 /*return*/];\n            }\n        });\n    }); }, function () { });\n    clearHistory.addEventListener(\"click\", function () {\n        modalConfirmClear.showModal();\n    });\n};\nwindow.addEventListener(\"load\", function () { return __awaiter(void 0, void 0, void 0, function () {\n    return __generator(this, function (_a) {\n        handleDeployTrigger();\n        handleClearHistory();\n        return [2 /*return*/];\n    });\n}); });\n\n\n//# sourceURL=webpack://mk-deployeur/./assets/scripts/deploy/index.ts?");
